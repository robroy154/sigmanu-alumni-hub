  ...
  return (
    <div className="mt-3 space-y-3 border-t border-white/10 pt-3">
      ...
      <textarea
        ...
        placeholder="Body"
        rows={3}
        className="w-full rounded-lg border border-white/20 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-sn-gold resize-none"
      />
