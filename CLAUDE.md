...
- Guest count display: "X attendees (you + N guests)" format used in MyEventsClient, admin registrations page; 1 attendee shows no parenthetical; admin registrations summary strip shows total guest count across all shown registrations; dashboard Registrations stat card sub-text shows paid count + total guests (e.g. "42 paid · 7 guests")
