...
- Phase 9: Email notifications via Resend (welcome, registration confirm, admin alert) — provider replaced by Brevo in Phase 23
...
- Phase 19: Hardening — pending confirmation email on signup/join; announcement batch notify (individual Brevo sendTransacEmail calls, chunked at 100); checkReferralToken pre-signUp guard; admin hard delete referrals (DeleteReferralButton); admin hard delete members (auth.admin.deleteUser cascade); docs/PRODUCTION_SETUP.md
